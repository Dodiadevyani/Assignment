...
def meantemp_from_tempdatafrme():
...
# to calculate growth duration of crop planting and harvesting date used
...
# to calculate growing degree days of crop needs mean temperature which find using mean_temp_from_tempdataframe function 
meantemp= meantemp_from_tempdatafrme()
# to input planting and harvesting date which is essential variable to calculate GDD using user_planting_date 
#and user_harvesting_date functions
planting_date= user_planting_date()
print planting_date
